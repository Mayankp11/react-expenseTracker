...
const schema = z.object({
    description: z.string().min(3,{message:"Description should be between 3 and 50 characters"}).max(50,{message:"Description should be between 3 and 50 characters"}),
  ...
  return (
    <form onSubmit={handleSubmit(data => console.log(data))}>
      ...
      <div className="mb-3">
        ...
        <select {...register('categories')} id="category" className="form-select">
        <option value=""></option>
